...
export default class Breakfast extends Component{
    ...
    /**
     * @function：queryCollectionPlant
     * @parameter：null
     * @description：Query the food collection database and display it
     */
    queryCollection=()=>
    {
        ...
        var ref = fire.database().ref("foodcollection").orderByChild("id").equalTo(user).once("value",(data)=>{
            ...
            for(let id in value) {
                ...
                //Store the obtained data in a local variable because it is easier to use
    ...
    render() {
        ...
        return (
          <div>
              {/*The display information of the card*/}
